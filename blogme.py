...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 25 00:10:56 2022
...
#reading Excelor xlsx files
data = pd.read_excel('articles.xlsx')

#Summuray of the data
data.describe()

#Summuray of the columns
data.info()

#counting the number of articles per spurce
...
a = aboutMe('Mamadou', 'Dembele', 'Ivory Coast')
...
africanfood = ['Attieke', 'Foufou', 'Placali']   
